...
public partial class Home {
 ...
 void OpenAttention(string key){if(key=="repo-pr"){_=OpenPullRequestCleanup();return;}if(key is "repo-merged" or "repo-orphan"){_=OpenBranchCleanup();return;}ClearFilters();attentionFilter=key;screen="workspace";workspaceMode="Overview";detail=null;dailyPanelItem=null;}
