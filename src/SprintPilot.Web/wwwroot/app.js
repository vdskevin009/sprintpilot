window.sprintPilot={
 ...
 init(dotnet){
  ...
  this.beforeInstallHandler=e=>{e.preventDefault();this.pwaPrompt=e;this.notifyPwa();};
  this.appInstalledHandler=()=>{this.pwaPrompt=null;this.notifyPwa();};
 ...
 dispose(){
  ...
  if(this.beforeInstallHandler)window.removeEventListener('beforeinstallprompt',this.beforeInstallHandler);
  if(this.appInstalledHandler)window.removeEventListener('appinstalled',this.appInstalledHandler);
  this.handler=this.beforeInstallHandler=this.appInstalledHandler=null;
  this.dotnet=null;
 }
};
