...
public sealed record WorkItem {
 ...
 public int Id {get;init;} public int Revision {get;init;} public int CommentCount {get;init;}
...
public record AzureProject(string Id,string Name);
public record GitRepository(string Id,string Name,string DefaultBranch);
