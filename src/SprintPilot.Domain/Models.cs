...
public sealed record WorkItem {
 ...
 public string Area {get;init;}=""; public double? Estimate {get;init;}
...
public enum ItemField {Title,Owner,State,Iteration,Area,Estimate,Priority,Tags,Description,Acceptance}
...
public record TypeDefinition(string Name,StateDefinition[] States,string[] Fields,string? EstimateField) {
...
public sealed class Preferences {
 ...
 public string[] Columns {get;set;}=["ID","Type","Title","Owner","State","Iteration","Estimate","Tags"];
 ...
 public Dictionary<string,int> QualityWeights {get;set;}=new(){["Clear title"]=15,["Description"]=15,["Acceptance criteria"]=15,["Parent"]=5,["Sprint"]=10,["Area"]=5,["Estimate"]=10,["Assignee"]=5,["Tags"]=5,["Testing information"]=10,["Distinct title"]=5};
